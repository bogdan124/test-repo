...
## Solved Problems
- Authentication Fixes - i just changed in controllers/userController.js and put a status .
-  UI Enhancement - I used a hover method added a transition with a transform and then I put an overflow hidden to not go out of the card .
- Order UI Fix - I look at the gap put by you and then i made a width and make the p tag to go in center with a text align. 
## Problems
